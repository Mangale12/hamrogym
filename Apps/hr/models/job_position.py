...
from Apps.hr.models.employeement_type import employeement_type
...
class job_position(models.Model):
    ...
    job_category = models.ForeignKey("job_category", on_delete=models.RESTRICT, null=True, blank=True, help_text="Job category associated with this job position")
    ...
    employeement_type = models.ForeignKey("employeement_type", on_delete=models.RESTRICT, null=True, blank=True, help_text="Employment type associated with this job position")
