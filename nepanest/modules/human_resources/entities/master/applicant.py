...
from nepanest.modules.recruitment.datatables import APPLICANT_COLUMNS, ApplicantDataTableView
from nepanest.modules.recruitment.forms import ApplicantForm
