...
from nepanest.modules.payroll.datatables import PayrollSettingDataTableView
from nepanest.modules.payroll.forms import PayrollSettingForm
from nepanest.modules.payroll.models import PayrollSetting
...
register_entity(
    EntityConfig(
        ...
        fields=[
            ...
            {"name": "overtime_earning_component", "label": "Overtime Earning Component", "type": "select", "required": False, "col": 4, "url_name": "salary_component_select"},
        ...
        datatable_columns=[
            ...
            {"name": "overtime_earning_component", "title": "OT Component"},
