...
1. `nepanest/modules/human_resources/entities/master/project.py`
2. `nepanest/modules/human_resources/datatables/project_data_table.py`
3. `nepanest/modules/human_resources/forms/project_form.py`
4. `nepanest/modules/human_resources/models/project.py` if `--create-model` is used

It also updates:

1. `nepanest/modules/human_resources/entities/__init__.py`
2. `nepanest/modules/human_resources/entities/master/__init__.py`
3. `nepanest/modules/human_resources/models/__init__.py` if model was generated inside `models/`
...
`nepanest/modules/human_resources/models/project.py`
...
`nepanest/modules/human_resources/forms/project_form.py`
...
`nepanest/modules/human_resources/datatables/project_data_table.py`
...
`nepanest/modules/human_resources/entities/master/project.py`
...
`nepanest/modules/human_resources/models/__init__.py`
...
`nepanest/modules/human_resources/sidebar.py`
...
`nepanest/modules/human_resources/views/project.py`
...
1. `nepanest/modules/<app>/models/<entity>.py`
2. `nepanest/modules/<app>/models/__init__.py`
3. `nepanest/modules/<app>/forms/<entity>_form.py`
4. `nepanest/modules/<app>/datatables/<entity>_data_table.py`
5. `nepanest/modules/<app>/entities/master/<entity>.py`
6. `nepanest/modules/<app>/entities/master/__init__.py`
7. `nepanest/modules/<app>/views/<entity>.py`
8. `nepanest/modules/<app>/sidebar.py`
...
1. `nepanest/modules/human_resources/models/project.py`
2. `nepanest/modules/human_resources/forms/project_form.py`
3. `nepanest/modules/human_resources/datatables/project_data_table.py`
4. `nepanest/modules/human_resources/entities/master/project.py`
5. `nepanest/modules/human_resources/views/project.py`
6. `nepanest/modules/human_resources/sidebar.py`
